...
class Element extends \bx\ar\ActiveRecord
{
	...
	protected function rules()
	{
		...
		if (!empty($toFloat)) $this->_rules[] = array($toFloat, 'filter', 'filter' => 'floatval');
		if (!empty($toInt)) $this->_rules[] = array($toInt, 'filter', 'filter' => 'intval');
		return $this->_rules;
	}
